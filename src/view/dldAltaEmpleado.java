...
public class dldAltaEmpleado extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dldAltaEmpleado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dldAltaEmpleado dialog = new dldAltaEmpleado(new javax.swing.JFrame(), true);
